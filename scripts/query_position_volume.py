...
def main():
    parser = argparse.ArgumentParser(description="Query TimeStore position available volume")
    ...
    available = data.get("availableVolume")
    hold = data.get("holdVolume")

    print(f"issuer_id={cfg['issuer_id']}")
    print(f"availableVolume={available}")
    print(f"holdVolume={hold}")
...
if __name__ == "__main__":
    start_run_logging("query_position_volume")
    main()
